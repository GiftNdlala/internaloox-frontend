...
export const getColors = () => apiRequest('/color-references/');
export const getFabrics = () => apiRequest('/fabric-references/');
...
export const getWarehouseProducts = () => apiRequest('/products/');
export const createWarehouseProduct = (data) => apiRequest('/products/', { method: 'POST', data });
...
// Product main image helpers (backend under /products/<id>/)
export const getProductMainImageUrl = (productId) => `${API_BASE}/products/${productId}/main_image/`;
export const uploadProductMainImage = (productId, file) => {
  const formData = new FormData();
  formData.append('file', file);
  return apiRequest(`/products/${productId}/upload_main_image/`, { method: 'POST', data: formData, isForm: true });
};
export const deleteProductMainImage = (productId) => apiRequest(`/products/${productId}/main_image/`, { method: 'DELETE' });
...
export const createColorReference = (data) => apiRequest('/color-references/', { method: 'POST', data });
export const createFabricReference = (data) => apiRequest('/fabric-references/', { method: 'POST', data });
...
export const getInventoryDashboard = () => apiRequest('/inventory/materials/warehouse_dashboard/');
